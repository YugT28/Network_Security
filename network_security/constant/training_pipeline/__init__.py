...
SCHEMA_FILE_PATH: str = Path('data_schema',"schema.yaml")
# os.path.join('data-schema', 'schema.yaml')
SCHEMA_DROP_COLS: str = 'drop_columns'

SAVED_MODEL_DIR: str = Path("saved_models")
...
DATA_INGESTION_DATABASE_NAME: str = "xyz"
